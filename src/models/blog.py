...
class Blog():
    ...
    def new_post(self,title,content,date=datetime.datetime.utcnow()):
        post= Post(blog_id=self._id,title=title, author=self.author,
                  content=content, created_date=date)
        post.save_to_mongo()
    ...
    #     blog_data = Database.find_one(collection='blogs', query={'id': id})
    #
    #     return Blog(author=blog_data['author'], title=blog_data['title'], description=blog_data['description'],
    #                 id=blog_data['id'])
